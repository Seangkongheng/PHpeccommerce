              ...
              <ul class="dropdown-menu  mt-4" aria-labelledby="navbarDropdown">
                <div class="all-dropdown d-flex">
                  <div class="firs-dropdown">
                    <li><a class="dropdown-item " href="bookpage.php">Girl</a></li>
        ...
        <ul>
          ...
          <li class="dropdown">
            <a class="text-decoration-none text-white " href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
              <span><a class="text-decoration-none text-white" href="viewcartEcom.php"><i style="font-size: 15px;" class="fa-solid fa-cart-shopping"></i>
                  <span style="font-size: 15px;" class="badge bg-danger">
                    <?php
  ...
  <div class="container">
    <div class="content-product-display">
      ...
      <div class="product-block-content">
        <div class="all-content-display-dicount-title">
          <div class="all-content-title">
            <p>Up to <span class="text-info" style="font-size: 30px;">100% </span>of Black friday</p>
            <H1>TRENDY <span class="text-info">FASHION</span></H1>
            <h1>COLLECTION </h1>
            <button class="btn btn-primary mt-3">BY NOW</button>
          </div>
          <div class="image-block-content-product">
            <img src="image/backgroundGirl.png" alt="">
          </div>
        </div>
          ...
          <p>Accessarie & Mobile</p>
            <div class="all-item-featured">
              ...
              $sql = "SELECT b.book_id,b.book_title,b.catagory,b.lavel,b.price,b.Author,b.stock,b.image,c.id,c.category_name,c.parent_id,c.level,c.description FROM book b INNER JOIN categories c ON b.catagory =c.id
               WHERE category_name IN('Accesssary','Oppo','Huawei','Mac book','MSI','kid') limit 12";
              ...
              ?>
                  <div class="featured-box mt-5">
                    <div class="product-filter">
                      <a href="bookpageDetail.php?id=<?php echo $row['book_id'] ?>"> <img src="../admin/upload/<?php echo $row["image"] ?>" alt=""></a>
                    </div>
                    ...
                    <div class="price">
                      <div class="price-number">
                        <p style="font-size: 18px;color:blue"><b><?php echo $row['price'] ?>.00$</b></p>
                      </div>
                      <div class="cart-button">
                        <a class="btnAdddTowish"><img src="image/add-to-wishlist-icon" alt=""></a><br>
                        <a class="btnAddTocart text-danger mt-2" href="book_add_tocard.php?id=<?php echo $row['book_id'] ?>"><i class="fa-solid fa-cart-plus"></i></a>
            ...
            <p class="mt-5">Men collection</p>
            <div class="all-item-featured">

              <?php
              $sql = "SELECT b.book_id,b.book_title,b.catagory,b.lavel,b.price,b.Author,b.stock,b.image,c.id,c.category_name,c.parent_id,c.level,c.description FROM book b INNER JOIN categories c ON b.catagory =c.id WHERE category_name='Man' limit 12";
            ...
            <p class="mt-5">girl Collection</p>
            <hr>
            <div class="all-item-featured">

              <?php
              $sql = "SELECT b.book_id,b.book_title,b.catagory,b.lavel,b.price,b.Author,b.stock,b.image,c.id,c.category_name,c.parent_id,c.level,c.description 
              FROM book b INNER JOIN categories c ON b.catagory =c.id WHERE category_name='Girl'limit 12";
