        ...
        <div class="book-all-content">
          ...
          <div class="all-content">
              ...
              $sql = "SELECT b.book_id,b.book_title,b.catagory,b.price,b.Author,b.stock,b.image,c.id,c.name,c.parrent_id,c.Decription,c.lavel 
               FROM book b 
               INNER JOIN tbl_catagory c ON b.catagory =c.id WHERE name='T-Thirt'";
              $sql_qeury = mysqli_query($conn, $sql);
              if (mysqli_num_rows($sql_qeury) > 0) {
                while ($row = mysqli_fetch_assoc($sql_qeury)) {
              ?>
                  <div class="book-item">
                    ...
                    <div class="title-book-by">
                      <small><?php echo $row["book_title"] ?></small>
                      <div class="Author">
                        <p class="">by : <span class="text-success"><?php echo $row["Author"] ?></span></p>
                      </div>
                    </div>
                    <div class="price-and-addtocart">
                      <p class=""><span class="text-danger"><?php echo $row['price'] ?>$</span></p>
                      <div class="all-btn">

                        <button class="btnAdddTowish"><img src="image/add-to-wishlist-icon" alt=""></button><br>
                        <a class="float-end btnAddTocart mt-2" href="book_add_tocard.php?id=<?php echo $row['book_id'] ?>"><i class="fa-solid fa-cart-plus"></i></a>
