...
<body>
    ...
    <!-- end nave -->
    <div class="all-content-contact-us">
        <div class="background-andd-title">
            <div class="background-contact-us-image">
                <img src="image/ecommerce backgorund.jpg" alt="">
            </div>
            <div class="title-contact-us">
                <h1>Get in touch</h1>
                <p>Want to get Tought? We'd have to hear from you</p>
            </div>

        </div>
        <div class="service-on-contact_us">
            <div class="all-service-contact-us">
                <div class="talk-to-sales">
                    <div class="all-content-on-talk-sale">
                        <div class="decription-on-talk-to-sales">
                        <i style="font-size: 50px;" class="fa-solid fa-phone"></i>
                            <h4 class="mt-4">Talk to sales</h4>
                            <p>Do you have anything that you dont understand about my website or you have the something or anything you can call to my service with below number:</p>
                            <br>
                            <p>+011557927</p>
                            <br>
                            <p><a href="" class="text-decoration-none">View all Globle numbers&nbsp;&nbsp;<i class="fa-solid fa-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
                <div class="contact-customer">
                    <div class="all-content-on-customer">
                        <div class="decription-on-customer">
                        <i style="font-size: 50px;" class="fa-solid fa-message"></i>
                            <h4 class="mt-4"><b>Contact Customer Support</b></h4>
                            <p>Do you have anything that you dont understand about my website or you have the something or anything you can call to my service with below number:</p>
                            <br>
                            
                            <br>
                            <p><a class="btn-support" href="contact_us_2.php">contact Support&nbsp;&nbsp;<i class="fa-solid fa-arrow-right"></i></a></p>
                        </div>
                    </div>
                </div>
            </div>
