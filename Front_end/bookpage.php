    ...
    <div class="container">
              ...
              <ul class="dropdown-menu  mt-4" aria-labelledby="navbarDropdown">
                <div class="all-dropdown d-flex">
                  <div class="firs-dropdown">
                    ...
                    <li><a class="dropdown-item " href="allpage/toy.php">Toy</a></li>
      ...
      <div class="right-menu">
        <ul>
          ...
          <!-- <li><a href="viewcartEcom.php">View carts</a></li> -->
            ...
            <div class="dropdown-menu mt-5 viewcart " aria-labelledby="dropdownMenuLink">
              <div class="card">
                <div class="card-header">
                  <p>shopping cart
                  <p>
                  <p class="count-item">you have <?php echo  $itemsNumber ?> item in cart</p>
                </div>
        ...
        <div class="book-all-content">
          <div class="scroler-container">
            <div class="all-content">
              <?php
              $sql = "SELECT b.book_id,b.book_title,b.catagory,b.lavel,b.price,b.Author,b.stock,b.image,c.id,c.category_name,c.parent_id,c.level,c.description FROM book b INNER JOIN categories c ON b.catagory =c.id WHERE catagory=4";
              $sql_qeury = mysqli_query($conn, $sql);
