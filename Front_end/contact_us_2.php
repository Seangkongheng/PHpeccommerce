...
<body>
    ...
    <!-- end nave -->   
   <div class="container">
   <div class="content-request-all">
        <h2 class="text-center mt-5 text-uppercase">Request  a call back</h2>
        <div class="content-request mt-5">
            <div class="form-and-location">
                    <div class="location-context">
                        <p>You can check my address for find anything whict do you want</p>
                        <p>  <i class="fa-solid fa-location-dot text-danger"></i>&nbsp;&nbsp;ADDRESS : kompng cham ,st168,homeNh</p>
                        <p>  <i  class="fa-solid fa-phone text-danger"></i>&nbsp;&nbsp;PHONE : 011558927</p>
                        <p>  <i class="fa-solid fa-square-envelope text-danger"></i>&nbsp;&nbsp;EMAIL : Konghengseang@123.com</p>
                        <div class="all-content-on-socail">
                    ...
                    <div class="mt-5 text-decoration-none">
                        <a class="text-decoration-none" href="contact_us.php"><i class="fa-solid fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                    </div>
                    </div>
                    <div class="form-reqeust">
                        <form action="">
                            <div class="row">
                                <div class="col-4">
                            ...
                            <textarea class="mt-4" name="" id="" cols="96" rows="10" placeholder="Message">
                       
                            </textarea><br><br><br>
                            <a class="btn-send" href="">SEND  &nbsp;&nbsp;<i class="fa-solid fa-paper-plane"></i></a>
                        </form>
                    </div>
            </div>
        </div>
